...
/app/kafka_2.11-0.9.0.0/bin/kafka-console-producer.sh --producer.config /data/kafka/cluster_3/conf/producer/producer.properties --broker-list ubuntu:9092 --topic topic_3
